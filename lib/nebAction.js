    ...
    if (result == 0) {
        ...
        if (result.length != 0) {      //"return value"
            ...
            result.forEach(function (item, index) {
                ...
                var category = $("<p class='card-category'></p>")
                category.text(item.category + ': ' + item.tags)
                
                body.append(title)
                body.append(category)
                body.append($("<p class='card-category' style='border-bottom: 1px solid; color: #FF5722; margin-bottom:0rem'>推荐美食</p>"))
