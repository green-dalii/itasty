...
var dappAddress = "n1zWKG4DudiXpYN4YmAbXG8b4WrLQUU2VuV";
    ...
    if (result == 0) {//empty input
        ...
        if (result.length != 0) {      //"return value"
            ...
            result.forEach(function (item, index) {
                ...
                body.append($("<p class='card-loc'><i class='fa fa-map-marker'></i>&nbsp地址</p>"))
